...
export default function WhatsAppButton() {
    return (
        <a
            ...
            className="whatsapp-pulse fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center shadow-lg transition-colors"
